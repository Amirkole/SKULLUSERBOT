...
from wand.image import Image as skullimage
...
async def skull_meme(topString, bottomString, filename, endname):
...
async def skull_meeme(upper_text, lower_text, picture_name, endname):
    main_image = skullimage(filename=picture_name)
    main_image.resize(
