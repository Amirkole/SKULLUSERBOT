...
if Config.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
        ...
        if query.startswith("**Skulluserbot") and event.query.user_id == bot.uid:
            buttons = [
                (
                    ...
                    Button.url("Repo", "https://github.com/hackelite01/SKULLUSERBOT.git"),
                )
            ]
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            reply_pop_up_alert = "Please get your own skulluserbot, and don't use mine! Join @skulluserbot help"
