...
CMD_HELP.update(
    {
        ...
        \n\n  鈥�  **Syntax : **`.setcity <city> or .setcity <city>, <country name/code>`\
        \n  鈥�  **Function : **__Sets your default city so you can just use .weather.__\
        \n\n  鈥�  **Syntax : **`.wttr <city> `\
        \n  鈥�  **Function : **__Shows you the climate data of 3 days from today in a image.__"
    }
)
