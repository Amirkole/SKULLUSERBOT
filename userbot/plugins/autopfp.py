# Made By @mayank1rajput Keep Credits If You Are Goanna Kang This Lol
...
async def main(event):
    await event.edit("Starting batman Profile Pic.")  # Owner @mayank1rajput
    while True:
        await animeppbat()
...
async def main(event):
    await event.edit("Starting thor Profile Pic.")  # Owner @mayank1rajput
    while True:
        await animeppthor()
        file = await event.client.upload_file("donottouch.jpg")
        await event.client(
