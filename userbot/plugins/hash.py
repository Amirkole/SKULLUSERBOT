# skulluserbot module containing hash and encode/decode commands.
    ...
    if event.pattern_match.group(1) == "en":
        if string:
            ...
            if mediatype is None:
                ...
                skullevent = await edit_or_reply(event, "`Encoding ...`")
                c_time = time.time()
        ...
        await edit_or_reply(
            skullevent, result, file_name="encodedfile.txt", caption="It's Encoded"
        )
